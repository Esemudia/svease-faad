                    ...
                    <div class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3"><a href="quotation.aspx">View All Quotation</a>
                           <asp:Button cssclass="btn btn-primary" runat="server" ID="btnReset" OnClick="btnReset_Click" Text="Reset" />
                            <asp:HiddenField runat="server" ID="hid" />
                         <asp:Button cssclass="btn btn-success" runat="server" ID="btnSubmit" OnClick="btnSubmit_Click" Text="Create Quotation"/>
