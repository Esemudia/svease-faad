<%@ Page Title="" Language="C#" MasterPageFile="~/faad.Master" AutoEventWireup="true" CodeBehind="poApproval.aspx.cs" Inherits="saveasze.poApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
              ...
              <div class="col-md-8 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Approve/Decline Purchase Order (<asp:Label ID="lblPO" runat="server"></asp:Label>)/Quotation(<asp:Label ID="lblQoutNo" runat="server"></asp:Label>) ----- <asp:Label ID="apprBy" runat="server" Text=""></asp:Label></h2>
                    ...
                    <div class="form-horizontal form-label-left">
                      ...
                      <asp:Label ID="lblcostCenter" runat="server" Visible="false"></asp:Label> 
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <asp:Label id="lblMarket"  class="form-control" runat="server" ></asp:Label>                          
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <asp:TextBox runat="server" ID="txtAdd" Width="100%" TextMode="MultiLine"  class="form-control col-md-3 col-sm-3 col-xs-12"  Enabled="false" ></asp:TextBox>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <asp:Label CssClass="form-control" runat="server" ID="txtSubTotal" Enabled="false"></asp:Label>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <asp:DropDownList ID="drpApprovalType" class="form-control" runat="server" >
                            </asp:DropDownList>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3"><a href="po.aspx">View All Purchase Order</a>
                          <button type="submit" class="btn btn-success" runat="server" id="btnSubmit" onserverclick="btnSubmit_ServerClick">Submit Approval</button>
                        </div>
                      </div>
