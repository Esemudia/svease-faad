<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="quotePrint.aspx.cs" Inherits="saveasze.quotePrint" %>
<!DOCTYPE html>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 ...
                 <button class="btn btn-primary pull-left"  onserverclick="btnPrint_ServerClick" runat="server" id="btnPrint" ><i class="fa fa-print"></i> Print Quotation</button>
                 <button class="btn btn-success pull-left" runat="server" id="btnPO" onserverclick="btnPO_ServerClick" ><i class="fa fa-credit-card"></i> Create PO</button>
                  ...
                  <div class="x_content">
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h1>
                                          ...
                                          <small class="pull-right">Quotation Date: <asp:Label ID="lblQtDate" runat="server" Text="19/05/2019"></asp:Label> </small>
                                      </h1>
                        </div>
                        <!-- /.col -->
                      </div>
                      ...
                      <div class="row invoice-info">
                        ...
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                          <b>Quotation <asp:Label ID="lblQtNo" runat="server" Text="123456"></asp:Label></b>
                          ...
                          <div class="table-responsive">
                            <table class="table">
                              <tbody>
                                ...
                                <tr>
                                  <th>VAT/Witholding (5%)</th>
                                  <td>N<asp:Label runat="server" ID="lblVat" Text=""></asp:Label></td>

                                </tr>
                                <tr>
                                  <th>NCD (1%)</th>
                                  <td>N<asp:Label runat="server" ID="lblNCD" Text=""></asp:Label></td>
