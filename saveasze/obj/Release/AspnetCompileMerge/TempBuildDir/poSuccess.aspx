<%@ Page Title="" Language="C#" MasterPageFile="~/faad.Master" AutoEventWireup="true" CodeBehind="poSuccess.aspx.cs" Inherits="saveasze.poSuccess" %>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <h3 class="prod_title">Purchase Order <asp:Label runat="server" ID="updStatus" Text=""></asp:Label> Successfully. -  <%=qtNumber %></h3>
