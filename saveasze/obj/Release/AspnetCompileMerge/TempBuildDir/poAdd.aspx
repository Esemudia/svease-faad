<%@ Page Title="" Language="C#" MasterPageFile="~/faad.Master" AutoEventWireup="true" CodeBehind="poAdd.aspx.cs" Inherits="saveasze.poAdd" %>
                    ...
                    <div class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                          <table align="center">
                              ...
                              <tbody>
                                  <tr>
                                      <td></td>
                                      <td><asp:CheckBox runat="server" ID="chkAGO" OnCheckedChanged="chkAGO_CheckedChanged" AutoPostBack="true" Text="AGO" /></td>
                                      <td style="display:none"><asp:Label runat="server" ID="lblAGO" Text="AGO"></asp:Label><asp:Label runat="server" ID="lblAGOID" Text="2" Visible="false"></asp:Label></td>
                                  ...
                                  <tr>
                                      <td></td>
                                      <td><asp:CheckBox runat="server" ID="chkDPK" OnCheckedChanged="chkDPK_CheckedChanged" AutoPostBack="true" Text="DPK" /></td>
                                  ...
                                  <tr>
                                      <td></td>
                                      <td><asp:CheckBox runat="server" ID="chkOMS" OnCheckedChanged="chkOMS_CheckedChanged" AutoPostBack="true" Text="PMS" /></td>
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3"><a href="po.aspx">View All Purchase Order</a>
                          ...
                          <button type="submit" class="btn btn-success" runat="server" id="btnSubmit" onserverclick="btnSubmit_ServerClick">Create Purchase Order</button>
                        </div>
                      </div>
