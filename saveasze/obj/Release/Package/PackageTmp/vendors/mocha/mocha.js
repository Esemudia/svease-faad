...
function HTML(runner, root) {
  ...
  runner.on('suite', function(suite){
    ...
    var el = fragment('<li class="suite"><h1><a href="../../../vendors/mocha/%s">%s</a></h1></li>', url, escape(suite.title));
  ...
  runner.on('test end', function(test){
    ...
    if ('passed' == test.state) {
      ...
      var el = fragment('<li class="test pass %e"><h2>%e<span class="duration">%ems</span> <a href="../../../vendors/mocha/%s" class="replay">‣</a></h2></li>', test.speed, test.title, test.duration, url);
    } else if (test.pending) {
      var el = fragment('<li class="test pass pending"><h2>%e</h2></li>', test.title);
    } else {
      var el = fragment('<li class="test fail"><h2>%e <a href="../../../vendors/mocha/?grep=%e" class="replay">‣</a></h2></li>', test.title, encodeURIComponent(test.fullTitle()));
